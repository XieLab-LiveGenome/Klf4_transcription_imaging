%% ===CDF for comparing enhancer-primary BRD4 hub distances between bursting and inactive states======

clear
clc

file_path = '/Users/janaa/Desktop/MS2 transcription/Condensate datasheets/Brd4 condensate analysis_single image_8-19-2025.xlsx';

CTRL_dist = readmatrix(file_path,'Sheet','ms intensity vs distance','Range','A2:A443');
...
thr = 4000;  % MS2 intensity threshold
